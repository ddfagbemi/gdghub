...
<div>
      ...
      <div class="row">
            <div class="span7 bordered shadowed fullWidth">        
                  ...
                  <?php echo $this->Form->input('title', array('default' => $job['Job']['name'])); ?>

                  <?php echo $this->Form->input('description', array('type' => 'textarea', 'default' => $job['Job']['description'], 'rows' => 10, 'required')); ?>
              <!--<div class="fullWidth">
<?php echo $this->Form->input('selSkills',array('id'=>'selSkills','label'=>'Enter Required Skills Below','required', 'default' => $job['Job']['description'])); ?>
              </div>-->
               <span id="searchLog"></span>
                  <?php echo $this->Form->input('registration_link', array('label'=>'Registration Link <em> &nbsp;(fully qualified url)</em>','default' => $job['Job']['registration_link'], )); ?>
		<!--
